...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2025 at 04:47 AM
...
--
ALTER TABLE `pembayaran`
  ADD CONSTRAINT `id_spp` FOREIGN KEY (`id_spp`) REFERENCES `siswa` (`id_spp`),
...
ALTER TABLE `siswa`
  ...
  ADD CONSTRAINT `siswa_ibfk_3` FOREIGN KEY (`nisn`) REFERENCES `pembayaran` (`nisn`);
COMMIT;
